...
inv.master = [
    ...
    { type: "h", name: "hormone", display: "Sissy Bimbo Pills", entry: false, count: 0, cost: 5, buy: null, image: "hormone.png", n: false, desc: "Take 1 pill a day to increase your female hormone level" },
    { type: "g", name: "lube", display: "Stuff My Butt Lube", entry: false, count: 0, cost: 2, buy: null, image: "lube.png", n: false, desc: "Lube for stuffing your Sissy Pussy" },
    ...
    { type: "m", name: "makeup", display: "Makeup", entry: false, count: 0, cost: 47, buy: 10, image: "makeup.png", n: false, desc: "Makeup kit [Sold as 100 uses]" },
    { type: "m", name: "eyeshadow", display: "Eyeshadow", entry: false, count: 0, cost: 22, buy: 5, image: "eyeshadow.png", n: false, desc: "Eyeshadow [Sold as 100 uses]" },
    { type: "m", name: "redl", display: "Red Lipstick", entry: false, count: 0, cost: 7, buy: 2, image: "redl.png", n: false, desc: "Red Lipstick [Sold as 100 uses]" },
    { type: "m", name: "pinkl", display: "Pink Lipstick", entry: false, count: 0, cost: 7, buy: 2, image: "pinkl.png", n: false, desc: "Pink Lipstick [Sold as 100 uses]" },
    { type: "m", name: "purplel", display: "Purple Lipstick", entry: false, count: 0, cost: 7, buy: 2, image: "purplel.png", n: false, desc: "Purple Lipstick [Sold as 100 uses]" },
    { type: "m", name: "bluel", display: "Blue Lipstick", entry: false, count: 0, cost: 7, buy: 2, image: "bluel.png", n: false, desc: "Blue Lipstick [Sold as 100 uses]" },
    { type: "m", name: "blackl", display: "Black Lipstick", entry: false, count: 0, cost: -1, buy: 2, image: "lipstickBlack.png", n: false, desc: "Stolen Black Lipstick [Sold as 100 uses]" },
    ...
    { type: "i", name: "pocketsand", display: "Pocket Sand", entry: false, count: 0, cost: 50, buy: null, image: "pocketsand.png", n: false, desc: "Decrease Enemy's fight total by 30 points." },
    ...
    { type: "b", name: "briefcase", display: "Briefcase", entry: false, count: null, cost: 60, buy: null, image: "breifcase.png", n: false, desc: "Boring ol' briefcase" },
    { type: "b", name: "slutPurse", display: "Slutty Pink Purse", entry: false, count: null, cost: 100, buy: null, image: "purse_slut.png", n: false, desc: "Only a true slut can use this" },
    { type: "b", name: "pinkPurse", display: "Pink Purse", entry: false, count: null, cost: 100, buy: null, image: "purse_pink.png", n: false, desc: "A cute purse" },
    { type: "b", name: "purseblack", display: "Black Purse", entry: false, count: null, cost: 80, buy: null, image: "purse_black.png", n: false, desc: "Black Purse" },
    { type: "b", name: "pinkcase", display: "Pink Briefcase", entry: false, count: null, cost: 80, buy: null, image: "purse_briefcase.png", n: false, desc: "A cute briefcase" },
    { type: "b", name: "pursebag", display: "Bag", entry: false, count: null, cost: 30, buy: null, image: "purse_bag.png", n: false, desc: "Bag" },
    { type: "b", name: "purseyellow", display: "Yellow Purse", entry: false, count: null, cost: 30, buy: null, image: "purse_yellow.png", n: false, desc: "A Yellow Purse" },
    { type: "b", name: "pursecoach", display: "Coach", entry: false, count: null, cost: 490, buy: null, image: "purse_coach.png", n: false, desc: "Noalita 17 in Signature Style" },
    { type: "b", name: "purseberkin", display: "Birkin Bag", entry: false, count: null, cost: 25900, buy: null, image: "berkin.png", n: false, desc: "Hermès Sac à Main Fou Hors de Prix 17" },
    ...
    { type: "p", name: "phoneTr", display: "Strong Woman", entry: false, count: null, cost: 35, buy: null, image: "phone_tr.png", n: false, desc: "" },
    { type: "p", name: "phonePink", display: "Pink", entry: false, count: null, cost: 35, buy: null, image: "phone_pink.png", n: false, desc: "" },
    { type: "p", name: "phoneLips", display: "Purple Lips", entry: false, count: null, cost: 35, buy: null, image: "phone_lips.png", n: false, desc: "" },
    { type: "p", name: "phoneShopping", display: "Shopping!", entry: false, count: null, cost: 50, buy: null, image: "phone_shopping.png", n: false, desc: "" },
    { type: "p", name: "phoneBlack", display: "Dancing", entry: false, count: null, cost: 50, buy: null, image: "phone_black.png", n: false, desc: "" },
    { type: "p", name: "phoneMan", display: "Sexy Man", entry: false, count: null, cost: 50, buy: null, image: "phone_man.png", n: false, desc: "" },
    { type: "p", name: "phoneFist", display: "Fisted Fem Dom", entry: false, count: null, cost: 85, buy: null, image: "phone_fist.png", n: false, desc: "" },
    ...
    { type: "d", name: "pinkDildo", display: "Pink Dildo", entry: false, count: null, cost: -1, buy: null, image: "dildoPink.png", n: false, desc: "Small Dildo" },
    ...
    { type: "d", name: "pinkFatDildo", display: "Fat Pink Dildo", entry: false, count: null, cost: -1, buy: null, image: "butt_fat.png", n: false, desc: "Fat pink futa dildo dick" },
    ...
    { type: "d", name: "vib0", display: "Clit Tickler", entry: false, count: null, cost: 140, buy: 45, image: "vib0.png", n: false, desc: "Chastity relief when masturbating" },
    ...
    { type: "c", name: "handcuff", display: "Handcuffs", entry: false, count: null, cost: 36, buy: null, image: "handcuffs.png", n: false, desc: "Handcuffs, you know, for your hands" },
    { type: "s", name: "straponSmall", display: "Small Strap-on", entry: false, count: null, cost: 180, buy: null, image: "straponSmall.png", n: false, desc: "Beginner strap-on" },
    ...
    { type: "r", name: "paint1", display: "Painting 1", entry: false, count: null, cost: 80, buy: null, image: "paint1.png", n: false, desc: "" },
    { type: "r", name: "paint2", display: "Painting 2", entry: false, count: null, cost: 50, buy: null, image: "paint2.png", n: false, desc: "" },
    { type: "r", name: "paint3", display: "Painting 3", entry: false, count: null, cost: 90, buy: null, image: "paint3.png", n: false, desc: "" },
    ...
    { type: "g", name: "chisel", display: "Chisel", entry: false, count: null, cost: -1, buy: null, image: "chisel.png", n: false, desc: "Used to break out of prison. " },
    { type: "g", name: "pizza", display: "Frozen Pizza", entry: false, count: 0, cost: 24, buy: null, image: "pizza.png", n: false, desc: "Frozen pizza for date night. " },
    { type: "g", name: "peanutbutter", display: "Peanut Butter", entry: false, count: 0, cost: 12, buy: null, image: "peanutbutter.png", n: false, desc: "Jar of Peanut Butter. " },
    ...
    { type: "y", name: "hypno1", display: "Hypno Lesson #1", entry: false, count: null, cost: 20, buy: null, image: "hypno1.png", n: false, desc: "Horny Girls Masturbate" },
    { type: "y", name: "hypno2", display: "Hypno Lesson #2", entry: false, count: null, cost: 40, buy: null, image: "hypno2.png", n: false, desc: "Pretty girl's wear makeup" },
    { type: "y", name: "hypno3", display: "Hypno Lesson #3", entry: false, count: null, cost: 40, buy: null, image: "hypno3.png", n: false, desc: "Girls wear dresses" },
    { type: "y", name: "hypno4", display: "Hypno Lesson #4", entry: false, count: null, cost: 50, buy: null, image: "hypno4.png", n: false, desc: "Blondes have more fun!" },
    { type: "y", name: "hypno5", display: "Hypno Lesson #5", entry: false, count: null, cost: 50, buy: null, image: "hypno5.png", n: false, desc: "Don't think too much" },
    { type: "y", name: "hypno6", display: "Hypno Lesson #6", entry: false, count: null, cost: 60, buy: null, image: "hypno6.png", n: false, desc: "Bimbo is better" },
    { type: "y", name: "hypno7", display: "Hypno Lesson #7", entry: false, count: null, cost: 100, buy: null, image: "hypno7.png", n: false, desc: "You are an object. Let men use you. All your holes and fuck holes" },
