...
inv.master = [
    ...
    { type: "m", name: "makeup", display: "Makeup", entry: false, count: 0, cost: 47, image: "makeup.png", n: false, desc: "Makeup kit [Sold as 100 uses]" },
    { type: "m", name: "eyeshadow", display: "Eyeshadow", entry: false, count: 0, cost: 22, image: "eyeshadow.png", n: false, desc: "Eyeshadow [Sold as 100 uses]" },
    { type: "m", name: "redl", display: "Red Lipstick", entry: false, count: 0, cost: 7, image: "redl.png", n: false, desc: "Red Lipstick [Sold as 100 uses]" },
    { type: "m", name: "pinkl", display: "Pink Lipstick", entry: false, count: 0, cost: 7, image: "pinkl.png", n: false, desc: "Pink Lipstick [Sold as 100 uses]" },
    { type: "m", name: "purplel", display: "Purple Lipstick", entry: false, count: 0, cost: 7, image: "purplel.png", n: false, desc: "Purple Lipstick [Sold as 100 uses]" },
    { type: "m", name: "bluel", display: "Blue Lipstick", entry: false, count: 0, cost: 7, image: "bluel.png", n: false, desc: "Blue Lipstick [Sold as 100 uses]" },
    { type: "m", name: "blackl", display: "Black Lipstick", entry: false, count: 0, cost: -1, image: "lipstickBlack.png", n: false, desc: "Stolen Black Lipstick [Sold as 100 uses]" },
    ...
    { type: "d", name: "vib0", display: "Clit Tickler", entry: false, count: null, cost: 140, image: "vib0.png", n: false, desc: "Chastity relief when masturbating" },
