...
inv.master = [
    { type: "g", name: "envelope", display: "Forest Queen's List", entry: false, count: null, cost: -1, buy: null, image: "envelope.png", n: false, desc: "Take this to Princess at the Detective Agency" },
    { type: "g", name: "usb", display: "USB Cult List", entry: false, count: null, cost: -1, buy: null, image: "usb.png", n: false, desc: "Use this in your home computer" },
    { type: "g", name: "missyusb", display: "USB for Missy`", entry: false, count: null, cost: -1, buy: null, image: "usb.png", n: false, desc: "Give this to Missy, or take a peek in your home PC" },
    ...
    { type: "x", name: "sissy0", display: "Sissy ID", entry: false, count: null, cost: 0, buy: null, image: "sissy0.png", n: false, desc: "Offical Sissy ID" },
    { type: "x", name: "sissy1", display: "Sissy ID", entry: false, count: null, cost: 0, buy: null, image: "sissy1.png", n: false, desc: "Offical Sissy ID" },
    { type: "x", name: "sissy2", display: "Sissy ID", entry: false, count: null, cost: 0, buy: null, image: "sissy2.png", n: false, desc: "Offical Sissy ID" },
    { type: "x", name: "sissy3", display: "Sissy ID", entry: false, count: null, cost: 0, buy: null, image: "sissy3.png", n: false, desc: "Offical Sissy ID" },

    { type: "u", name: "diploma", display: "Diploma", entry: false, count: null, cost: 0, buy: null, image: "diploma.png", n: false, desc: "Missy's Finishing School for Sissies" },

    { type: "o", name: "gym", display: "Gym Pass", entry: false, count: null, cost: 0, buy: null, image: "gymPass.png", n: false, desc: "Get entry to the gym" },
    { type: "l", name: "lockpick", display: "Lock Pick Set", entry: false, count: null, cost: 0, buy: null, image: "lockpick.png", n: false, desc: "Lock Pick Set for use on cases" },
    { type: "m", name: "makeup", display: "Makeup", entry: false, count: 0, cost: 47, buy: null, image: "makeup.png", n: false, desc: "Makeup kit [Sold as 100 uses]" },
    { type: "m", name: "eyeshadow", display: "Eyeshadow", entry: false, count: 0, cost: 22, buy: null, image: "eyeshadow.png", n: false, desc: "Eyeshadow [Sold as 100 uses]" },
    { type: "m", name: "redl", display: "Red Lipstick", entry: false, count: 0, cost: 7, buy: null, image: "redl.png", n: false, desc: "Red Lipstick [Sold as 100 uses]" },
    { type: "m", name: "pinkl", display: "Pink Lipstick", entry: false, count: 0, cost: 7, buy: null, image: "pinkl.png", n: false, desc: "Pink Lipstick [Sold as 100 uses]" },
    { type: "m", name: "purplel", display: "Purple Lipstick", entry: false, count: 0, cost: 7, buy: null, image: "purplel.png", n: false, desc: "Purple Lipstick [Sold as 100 uses]" },
    { type: "m", name: "bluel", display: "Blue Lipstick", entry: false, count: 0, cost: 7, buy: null, image: "bluel.png", n: false, desc: "Blue Lipstick [Sold as 100 uses]" },
    { type: "m", name: "blackl", display: "Black Lipstick", entry: false, count: 0, cost: -1, buy: null, image: "lipstickBlack.png", n: false, desc: "Stolen Black Lipstick [Sold as 100 uses]" },
    { type: "o", name: "landlordKey", display: "Landlord's Key", entry: false, count: null, cost: 0, buy: null, image: "llKey.png", n: false, desc: "Landlord's Key" },
    { type: "o", name: "flatmateKey", display: "Flatmate's Key", entry: false, count: null, cost: 0, buy: null, image: "elKey.png", n: false, desc: "Co-Tenant's Key" },
    { type: "o", name: "keyJanice", display: "Girl Friend's Key", entry: false, count: null, cost: 0, buy: null, image: "keyJanice.png", n: false, desc: "Key to Girl Friend's house. " },
    { type: "o", name: "kkey", display: "Jeffery's Desk Key", entry: false, count: null, cost: 0, buy: null, image: "kkey.png", n: false, desc: "Desk key for Jeffery's side drawer" },
    { type: "o", name: "reddoor", display: "Red Door Key", entry: false, count: null, cost: 0, buy: null, image: "redroom.png", n: false, desc: "Red Door Key" },
    { type: "o", name: "key202", display: "Apartment 202 Key", entry: false, count: null, cost: 0, buy: null, image: "key202.png", n: false, desc: "Key for Holly, Dolly, and Molly's Apartment" },
    { type: "o", name: "cavekey", display: "Cave Key", entry: false, count: null, cost: 0, buy: null, image: "cavekey.png", n: false, desc: "Key to get into the forest cave." },
    ...
    { type: "b", name: "briefcase", display: "Briefcase", entry: false, count: null, cost: 60, buy: 20, image: "breifcase.png", n: false, desc: "Boring ol' briefcase" },
    { type: "b", name: "slutPurse", display: "Slutty Pink Purse", entry: false, count: null, cost: 100, buy: 30, image: "purse_slut.png", n: false, desc: "Only a true slut can use this" },
    { type: "b", name: "pinkPurse", display: "Pink Purse", entry: false, count: null, cost: 100, buy: 30, image: "purse_pink.png", n: false, desc: "A cute purse" },
    { type: "b", name: "purseblack", display: "Black Purse", entry: false, count: null, cost: 80, buy: 25, image: "purse_black.png", n: false, desc: "Black Purse" },
    { type: "b", name: "pinkcase", display: "Pink Briefcase", entry: false, count: null, cost: 80, buy: 25, image: "purse_briefcase.png", n: false, desc: "A cute briefcase" },
    { type: "b", name: "pursebag", display: "Bag", entry: false, count: null, cost: 30, buy: 10, image: "purse_bag.png", n: false, desc: "Bag" },
    { type: "b", name: "purseyellow", display: "Yellow Purse", entry: false, count: null, cost: 30, buy: 10, image: "purse_yellow.png", n: false, desc: "A Yellow Purse" },
    { type: "b", name: "pursecoach", display: "Coach", entry: false, count: null, cost: 490, buy: 100, image: "purse_coach.png", n: false, desc: "Noalita 17 in Signature Style" },
    { type: "b", name: "purseberkin", display: "Birkin Bag", entry: false, count: null, cost: 25900, buy: 1500, image: "berkin.png", n: false, desc: "Hermès Sac à Main Fou Hors de Prix 17" },
    
    { type: "p", name: "phoneBasic", display: "Basic Phone", entry: true, count: null, cost: -1, buy: null, image: "phone_basic.png", n: false, desc: "Default phone case" },
    { type: "p", name: "phoneTr", display: "Strong Woman", entry: false, count: null, cost: 35, buy: 10, image: "phone_tr.png", n: false, desc: "" },
    { type: "p", name: "phonePink", display: "Pink", entry: false, count: null, cost: 35, buy: 10, image: "phone_pink.png", n: false, desc: "" },
    { type: "p", name: "phoneLips", display: "Purple Lips", entry: false, count: null, cost: 35, buy: 10, image: "phone_lips.png", n: false, desc: "" },
    { type: "p", name: "phoneShopping", display: "Shopping!", entry: false, count: null, cost: 50, buy: 15, image: "phone_shopping.png", n: false, desc: "" },
    { type: "p", name: "phoneBlack", display: "Dancing", entry: false, count: null, cost: 50, buy: 15, image: "phone_black.png", n: false, desc: "" },
    { type: "p", name: "phoneMan", display: "Sexy Man", entry: false, count: null, cost: 50, buy: 15, image: "phone_man.png", n: false, desc: "" },
    { type: "p", name: "phoneFist", display: "Fisted Fem Dom", entry: false, count: null, cost: 85, buy: 27, image: "phone_fist.png", n: false, desc: "" },

    { type: "z", name: "vib", display: "Li'l Remote Vibrator", entry: false, count: null, cost: -1, buy: null, image: "vib.png", n: false, desc: "Remote vibrator to stimulate the clit and G-spot." },
    { type: "g", name: "screwdriver", display: "Screwdriver", entry: false, count: null, cost: 50, buy: 10, image: "screwdriver.png", n: false, desc: "Go screw yourself" },
    { type: "d", name: "purpleDildo", display: "Purple Dildo", entry: false, count: null, cost: 40, buy: 5, image: "dildoPurple.png", n: false, desc: "Small Dildo" },
    { type: "d", name: "pinkDildo", display: "Pink Dildo", entry: false, count: null, cost: -1, buy: 10, image: "dildoPink.png", n: false, desc: "Small Dildo" },
    { type: "d", name: "whiteDildo", display: "White Dildo", entry: false, count: null, cost: 60, buy: 15, image: "butt_whiteCock.png", n: false, desc: "Averge Dildo" },
    { type: "d", name: "blackDildo", display: "Black Dildo", entry: false, count: null, cost: -1, buy: null, image: "butt_blackCock.png", n: false, desc: "Slightly Larger than average dildo" },
    { type: "d", name: "pinkFatDildo", display: "Fat Pink Dildo", entry: false, count: null, cost: -1, buy: 120, image: "butt_fat.png", n: false, desc: "Fat pink futa dildo dick" },
    { type: "d", name: "blackBallsDildo", display: "Anal Beads", entry: false, count: null, cost: 40, buy: 10, image: "butt_balls.png", n: false, desc: "Balls you put in your ass" },
    { type: "d", name: "towerDildo", display: "Tower of Power", entry: false, count: null, cost: 90, buy: 30, image: "butt_tower.png", n: false, desc: "Stretch that sissy hole" },
    { type: "d", name: "horseDildo", display: "Horse Dildo", entry: false, count: null, cost: 180, buy: 60, image: "butt_horse.png", n: false, desc: "You'll blow your ass out" },
    { type: "d", name: "vib0", display: "Clit Tickler", entry: false, count: null, cost: 140, buy: null, image: "vib0.png", n: false, desc: "Chastity relief when masturbating" },
    
    { type: "q", name: "pump", display: "Breast Pump", entry: false, count: null, cost: 120, buy: 40, image: "pump.png", n: false, desc: "BP-900 for sucking that milk from your titties!" },

    { type: "c", name: "handcuff", display: "Handcuffs", entry: false, count: null, cost: 36, buy: 12, image: "handcuffs.png", n: false, desc: "Handcuffs, you know, for your hands" },
    { type: "s", name: "straponSmall", display: "Small Strap-on", entry: false, count: null, cost: 180, buy: 30, image: "straponSmall.png", n: false, desc: "Beginner strap-on" },

    { type: "t", name: "tinypp", display: "Tiny PP", entry: false, count: null, cost: -1, buy: null, image: "tinypp.png", n: false, desc: "Shrink your pp" },
    { type: "z", name: "tifgift", display: "Gift From Tiffany", entry: false, count: null, cost: -1, buy: null, image: "tifGift.png", n: false, desc: "Go home and chek it out" },
    { type: "r", name: "paint1", display: "Painting 1", entry: false, count: null, cost: 80, buy: 20, image: "paint1.png", n: false, desc: "Room at Tif's" },
    { type: "r", name: "paint2", display: "Painting 2", entry: false, count: null, cost: 50, buy: 10, image: "paint2.png", n: false, desc: "Room at Tif's" },
    { type: "r", name: "paint3", display: "Painting 3", entry: false, count: null, cost: 90, buy: 25, image: "paint3.png", n: false, desc: "Room at Tif's" },
    { type: "g", name: "sewer", display: "Sewer Lid Opener", entry: false, count: null, cost: -1, buy: null, image: "sewer.png", n: false, desc: "Use this to open the sewer lid next to the dance club." },
    ...
    { type: "a", name: "roses", display: "Roses", entry: false, count: 0, cost: 45, buy: 9, image: "roses.png", n: false, desc: "A dozen red roses" },
    { type: "a", name: "seal", display: "Seal", entry: false, count: 0, cost: 12, buy: 4, image: "seal.png", n: false, desc: "Seal plush toy" },
    { type: "a", name: "turtle", display: "Turtle", entry: false, count: 0, cost: 12, buy: 4, image: "turtle.png", n: false, desc: "Turtle plush toy" },
    ...
    { type: "1", name: "mr_blueblanket", display: "Blue Blanket", entry: true, count: 1, cost: 80, buy: 20, image: "mr_blueblanket.png", n: false, desc: "Blankets for your bed." },
    { type: "1", name: "mr_pinkblanket", display: "Pink Blanket", entry: false, count: null, cost: 80, buy: 20, image: "mr_pinkblanket.png", n: false, desc: "Blankets for your bed." },
    { type: "1", name: "mr_purpleblanket", display: "Purple Blanket", entry: false, count: null, cost: 80, buy: 20, image: "mr_purpleblanket.png", n: false, desc: "Blankets for your bed." },

    { type: "2", name: "mr_rugblue", display: "Blue Rug", entry: true, count: 1, cost: 240, buy: 80, image: "mr_rugblue.png", n: false, desc: "Rug for your room." },
    { type: "2", name: "mr_rugpink", display: "Pink Rug", entry: false, count: null, cost: 240, buy: 80, image: "mr_rugpink.png", n: false, desc: "Rug for your room." },
    { type: "2", name: "mr_rugpurple", display: "Purple Rug", entry: false, count: null, cost: 240, buy: 80, image: "mr_rugpurple.png", n: false, desc: "Rug for your room." },

    { type: "3", name: "mr_poseter_1", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_1.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_2", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_2.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_3", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_3.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_4", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_4.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_5", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_5.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_6", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_6.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_7", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_7.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_8", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_8.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_9", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_9.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_10", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_10.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_11", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_11.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_12", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_12.png", n: false, desc: "Poster for your room." },
    { type: "3", name: "mr_poseter_13", display: " ", entry: false, count: null, cost: 35, buy: 7, image: "mr_poseter_13.png", n: false, desc: "Poster for your room." },

    { type: "y", name: "hypno1", display: "Hypno Lesson #1", entry: false, count: null, cost: 20, buy: 5, image: "hypno1.png", n: false, desc: "Horny Girls Masturbate" },
    { type: "y", name: "hypno2", display: "Hypno Lesson #2", entry: false, count: null, cost: 40, buy: 10, image: "hypno2.png", n: false, desc: "Pretty girl's wear makeup" },
    { type: "y", name: "hypno3", display: "Hypno Lesson #3", entry: false, count: null, cost: 40, buy: 10, image: "hypno3.png", n: false, desc: "Girls wear dresses" },
    { type: "y", name: "hypno4", display: "Hypno Lesson #4", entry: false, count: null, cost: 50, buy: 10, image: "hypno4.png", n: false, desc: "Blondes have more fun!" },
    { type: "y", name: "hypno5", display: "Hypno Lesson #5", entry: false, count: null, cost: 50, buy: 10, image: "hypno5.png", n: false, desc: "Don't think too much" },
    { type: "y", name: "hypno6", display: "Hypno Lesson #6", entry: false, count: null, cost: 60, buy: 10, image: "hypno6.png", n: false, desc: "Bimbo is better" },
    { type: "y", name: "hypno7", display: "Hypno Lesson #7", entry: false, count: null, cost: 100, buy: 20, image: "hypno7.png", n: false, desc: "You are an object. Let men use you. All your holes and fuck holes" },
];
            ...
            if (ti !== null) {
                ...
                if (thisInv.count === null) {
                    ...
                    if(inv.master[ti].type === "m")
                        inv.master[ti].count += (thisCount * 100);
                    else
