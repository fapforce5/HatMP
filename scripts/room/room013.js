    ...
    if (chatID === 999) {
        ...
        switch (lolaLevel) {
            ...
            case 1:
                ...
                buttons = [
                    { chatID: -1, text: "Do you want a massage?", callback: "massage1" },
                    { chatID: 998, text: "Do you want a massage? It's even better without a shirt. " + charisma.getStats(4).txt, callback: "massage1chance" }
                ];
                break;
            case 2:
                txt = "I know you go swimming a lot, do you need a massage? "
                buttons = [
                    { chatID: -1, text: "Do you want a massage? It's even better without a shirt. ", callback: "massage2" },
                    { chatID: -1, text: "Your glutes seem stressed, do you want me to massage them? " + charisma.getStats(5).txt, callback: "massage2chance" }
                ];
                break;
            case 3:
                txt = "I know you go swimming a lot, do you need a massage? "
                buttons = [
                    { chatID: -1, text: "Your glutes seem stressed, do you want me to massage them?", callback: "massage3" },
                    { chatID: -1, text: "It's better to massage your glutes without your skirt. " + charisma.getStats(6).txt, callback: "massage3chance" }
                ];
                break;
            case 4:
                txt = "I know you go swimming a lot, do you need a massage? "
                buttons = [
                    { chatID: -1, text: "It's better to massage your glutes without your skirt. ", callback: "massage4" },
                ];
                break;
        };
        return {
