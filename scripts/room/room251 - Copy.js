    ...
    switch (name) {
        case "jeff":
            if (g.pass === "startWork") {
                ...
                if ((missy.activecase().caseId === 14) && sc.getMission("holly", "case").complete) {
                    //
                }
                else {
                    //
...
room251.chat = function (chatID) {
    var cArray = [
        ...
        },
        {
            ...
            text: "...",
            button: [
                { chatID: 11, text: "[Remove your shirt]", callback: "ws1" }
            ]
        },
        {
            chatID: 11,
        ...
        },
        {
            ...
            button: [
                { chatID: -1, text: "Oh right, sorry.", callback: "leave" }
            ]
        },
        {
            chatID: 25,
        ...
        },
        {
            chatID: 28,
            speaker: "jeffery",
            text: "D-d-d-d-did you catch them yet?",
            button: [
