...
room8.main = function () {
    ...
    if (g.pass === 52)
        ...
        nav.bg("8_wardrobe/587_bathroom.jpg");
    else if (g.pass === 320)
        nav.bg("320_bathroom/bgc.jpg");
    else if (g.pass === 477)
        nav.bg("8_wardrobe/477.jpg");
    else if (g.pass === 602)
        ...
        nav.bg("8_wardrobe/483.jpg");
    else if (g.pass === 527)
        nav.bg("8_wardrobe/527.jpg");
    else if (g.pass === 482)
        nav.bg("482_bathroom/blur.webp");
    else {
        g.pass = 451;
        nav.bg("8_wardrobe/451.jpg");
    }
