...
fame.charList = function (isRape) {
    if (isRape) {
        ...
        return publicList[Math.floor(Math.random() * publicList.length)];
    }
    else {
        var rapeList = [
            {
...
fame.position0 = function (char) {
    ...
    switch (char) {
        ...
        case "man3":
            ...
            txt = "I want to stab you to death and play around with your blood, but maybe fucking your face will do. ";
            break;
    }
};
