...
sc.events = [
    ...
    { name: "landlord", step: 1, txt: "Can work as sperm store. ", img: "", show: true, ach: false },
    { name: "landlord", step: 2, txt: "Donated sperm first time. ", img: "", show: true, ach: false },
    { name: "landlord", step: 3, txt: "Advertised first time. ", img: "", show: true, ach: false },
...
sc.mission = [
    ...
    { id: 1, name: "eva", missionName: "getwine", mStatus: 0, title: "Get Wine!", desc: "Purchase some wine for truth or dare! " },
    { id: 2, name: "landlord", missionName: "spermbank", mStatus: 0, title: "Helping at the Sperm Bank", desc: "On Saturday Morning visit the Sperm Bank to help out. " },
...
sc.startMission = function (name, missionName) {
    for (var i = 0; i < sc.mission.length; i++) {
        if (sc.mission[i].name === name && sc.mission[i].missionName === missionName) {
            if (sc.mission[i].mStatus === 0 || sc.mission[i].mStatus < 100)
                sc.mission[i].mStatus = 1;
            break;
        }
    }
};
    ...
    for (var i = 0; i < sc.mission.length; i++) {
        if (sc.mission[i].name === name && sc.mission[i].missionName === missionName) {
            return {
                ...
                notStarted: sc.mission[i].mStatus === 0,
                inProgress: sc.mission[i].mStatus > 0 && sc.mission[i].mStatus < 100,
                complete: sc.mission[i].mStatus > 100
            };
        }
    }
...
sc.completeMission = function (name, missionName, success) {
    for (var i = 0; i < sc.mission.length; i++) {
        if (sc.mission[i].name === name) {
            sc.mission[i].mStatus = success ? 100 : 101;
            break;
        }
    }
};
...
sc.load = function (ra) {
    ...
    for (i = 0; i < sc.mission.length; i++) {
        sc.mission[i].mStatus = 0;
    }
    for (i = 0; i < ra.mission.length; i++) {
        sc.mission[ra.mission[i].id].mStatus = ra.mission[ra.mission[i].id].mStatus;
    }
};
    ...
    switch (char) {
        case "landlord":
            ...
            //sunday
                ...
                { d: [0], hstart: 11, hend: 18, roomId: 17, alt: null }, //living room
